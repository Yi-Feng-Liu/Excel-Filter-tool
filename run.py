...
class Excel_GUI:
    def __init__(self, root):
        ...
        # set the app icon
        self.iconimg = self.getIcon('D:\\GUI\\Test\\icon.jpg')
        ...
        self.origin_img_path = self.resize('D:\\GUI\\Test\\456.jpg', resize_w=100, resize_h=100, changeBG=True)
        ...
        self.button_img = self.resize('D:\\GUI\\Test\\confirm.jpg', resize_w=70, resize_h=60, changeBG=False)
